...
namespace LinqProject
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //var result1 = products.Where(p => p.UnitPrice > 5000); bu şekilde de yazılabilir.
        ...
        {
            return products.Where(product => product.UnitPrice > 5000 && product.UnitsInStock > 3).ToList();  // arka planda bir döngü oluşturup şartları kontrol edip liste oluşturuyor.Bu sebeple sonuna ToList ekle.
        }
    } 
